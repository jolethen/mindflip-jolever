 ...
 * Sound Integrated - No external assets required
 */
...
// --- 🎮 GAME CORE ---
window.startGame = () => {
    if (audioCtx.state === 'suspended') audioCtx.resume(); // Chrome fix
